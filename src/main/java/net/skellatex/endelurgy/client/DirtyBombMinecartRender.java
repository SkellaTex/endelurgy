...
public class DirtyBombMinecartRender extends MinecartRenderer<MinecartDirtyBomb> {

    private final BlockRenderDispatcher blockRenderer;

    public DirtyBombMinecartRender(EntityRendererProvider.Context p_174424_) {
        super(p_174424_, ModelLayers.TNT_MINECART);
        this.blockRenderer = p_174424_.getBlockRenderDispatcher();
    }

    protected void renderMinecartContents(MinecartDirtyBomb p_116151_, float p_116152_, BlockState p_116153_, PoseStack p_116154_, MultiBufferSource p_116155_, int p_116156_) {
