...
@OnlyIn(Dist.CLIENT)
public class WingedEnderiteChestplateModel<T extends LivingEntity> extends AgeableListModel<T> {
    public static final ModelLayerLocation WINGS_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Endelurgy.MOD_ID, "winged_enderite_chestplate"), "main");
    private final ModelPart rightWing;
    private final ModelPart leftWing;

    public WingedEnderiteChestplateModel(ModelPart pRoot) {
