...
public class WingedEnderiteChestplateLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    public WingedEnderiteChestplateLayer(RenderLayerParent<T, M> p_174493_, EntityModelSet p_174494_) {
        super(p_174493_);
    ...
    public boolean shouldRender(ItemStack stack, T entity) {
        return stack.getItem() == EItems.WINGED_ENDERITE_CHESTPLATE.get();
    }

    public ResourceLocation getElytraTexture(ItemStack stack, T entity) {
        return WINGS_LAYER_LOCATION;
    }
}