...
public enum EArmorMaterials implements ArmorMaterial {
    ...
    ENDERITE("enderite", 40, new int[]{ 3, 8, 6, 3 }, 25,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 3f, 0.25f, () -> Ingredient.of(ETags.Items.ENDERITE_REPAIR_MATERIALS));
    ...
    EArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantmentValue, SoundEvent equipSound,
    ...
    public String getName() {
        return Endelurgy.MOD_ID + ":" + this.name;
    }
