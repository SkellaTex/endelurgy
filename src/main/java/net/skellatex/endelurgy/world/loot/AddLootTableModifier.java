...
{
    public static final Supplier<Codec<net.skellatex.endelurgy.world.loot.AddLootTableModifier>> CODEC = Suppliers.memoize(() ->
            RecordCodecBuilder.create(inst -> codecStart(inst)
                    .and(ResourceLocation.CODEC.fieldOf("lootTable").forGetter((m) -> m.lootTable))
                    .apply(inst, net.skellatex.endelurgy.world.loot.AddLootTableModifier::new)));
